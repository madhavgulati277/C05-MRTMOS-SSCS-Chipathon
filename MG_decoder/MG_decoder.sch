...
F {}
E {}
T {DECODER - fully routed gate level netlist} -2400 -900 0 0 0.8 0.8 {}
T {Inputs P13..P19 enter on the left, one horizontal track each.} -2400 -840 0 0 0.4 0.4 {}
T {Crossing wires are NOT connected; junctions are drawn as solder dots by xschem.} -2400 -800 0 0 0.4 0.4 {}
T {VDD / GND are distributed by label (standard practice), ports declared top left.} -2400 -760 0 0 0.4 0.4 {}
...
N -2400 -400 4800 -400 {lab=P18}
N -2400 -600 -2280 -600 {lab=VDD}
N -2400 -700 -2280 -700 {lab=GND}
N -2400 -150 1320 -150 {lab=P13}
N -2280 -150 -2280 0 {lab=P13}
N -2280 0 -1280 0 {lab=P13}
N -1080 -150 -1080 880 {lab=P13}
N -1080 880 -80 880 {lab=P13}
N -1040 -150 -1040 1220 {lab=P13}
N -1040 1220 -80 1220 {lab=P13}
N 1320 -150 1320 280 {lab=P13}
N 1320 280 2320 280 {lab=P13}
N -2400 150 1360 150 {lab=P14}
N -2240 150 -2240 300 {lab=P14}
N -2240 300 -1280 300 {lab=P14}
N -1000 150 -1000 920 {lab=P14}
N -1000 920 -80 920 {lab=P14}
N -960 150 -960 1180 {lab=P14}
N -960 1180 -80 1180 {lab=P14}
N 1360 150 1360 580 {lab=P14}
N 1360 580 2320 580 {lab=P14}
N -2400 450 160 450 {lab=P15}
N -2200 450 -2200 600 {lab=P15}
N -2200 600 -1280 600 {lab=P15}
N -920 450 -920 580 {lab=P15}
N -920 580 -80 580 {lab=P15}
N 120 -20 120 450 {lab=P15}
N 120 -20 1120 -20 {lab=P15}
N 160 450 160 920 {lab=P15}
N 160 920 1120 920 {lab=P15}
N -2400 750 1400 750 {lab=P16}
N -2160 750 -2160 900 {lab=P16}
N -2160 900 -1280 900 {lab=P16}
N -880 320 -880 750 {lab=P16}
N -880 320 -80 320 {lab=P16}
N 200 750 200 1220 {lab=P16}
N 200 1220 1120 1220 {lab=P16}
N 1400 750 1400 880 {lab=P16}
N 1400 880 2320 880 {lab=P16}
N -2400 1050 280 1050 {lab=P17}
N 240 1050 240 1480 {lab=P17}
N 240 1480 1120 1480 {lab=P17}
N 280 1050 280 1820 {lab=P17}
N 280 1820 1120 1820 {lab=P17}
N -2400 1350 2520 1350 {lab=P19}
N 2520 1350 2520 1520 {lab=P19}
N 2520 1520 3520 1520 {lab=P19}
N -1120 0 -840 0 {lab=P13B}
N -840 0 -840 1650 {lab=P13B}
N -840 1650 320 1650 {lab=P13B}
N -800 -20 -800 1650 {lab=P13B}
N -800 -20 -80 -20 {lab=P13B}
N 320 580 320 1650 {lab=P13B}
N 320 580 1120 580 {lab=P13B}
N -1120 300 -760 300 {lab=P14B}
N -760 300 -760 1950 {lab=P14B}
N -760 1950 360 1950 {lab=P14B}
N -720 20 -720 1950 {lab=P14B}
N -720 20 -80 20 {lab=P14B}
N 360 280 360 1950 {lab=P14B}
N 360 280 1120 280 {lab=P14B}
N -1120 600 -680 600 {lab=P15B}
N -680 280 -680 600 {lab=P15B}
N -680 280 -80 280 {lab=P15B}
N -1120 900 -640 900 {lab=P16B}
N -640 620 -640 900 {lab=P16B}
N -640 620 -80 620 {lab=P16B}
N 80 0 440 0 {lab=S4}
N 400 0 400 1780 {lab=S4}
N 400 20 1120 20 {lab=S4}
N 400 1180 1120 1180 {lab=S4}
N 400 1780 1120 1780 {lab=S4}
N 80 300 480 300 {lab=N1}
N 480 300 480 320 {lab=N1}
N 480 320 1120 320 {lab=N1}
N 80 600 520 600 {lab=N3}
N 520 600 520 620 {lab=N3}
N 520 620 1120 620 {lab=N3}
N 80 900 560 900 {lab=N5}
N 560 880 560 900 {lab=N5}
N 560 880 1120 880 {lab=N5}
N 80 1200 600 1200 {lab=N8}
N 600 1200 600 1520 {lab=N8}
N 600 1520 1120 1520 {lab=N8}
N 1280 0 1440 0 {lab=S5}
N 1280 300 1480 300 {lab=N2}
N 1480 300 1480 320 {lab=N2}
N 1480 320 2320 320 {lab=N2}
N 1280 600 1520 600 {lab=N4}
N 1520 600 1520 620 {lab=N4}
N 1520 620 2320 620 {lab=N4}
N 1280 900 1560 900 {lab=N6}
N 1560 900 1560 920 {lab=N6}
N 1560 920 2320 920 {lab=N6}
N 1280 1200 1600 1200 {lab=N7}
N 1600 1200 1600 1480 {lab=N7}
N 1600 1480 2320 1480 {lab=N7}
N 1280 1500 1640 1500 {lab=N9}
N 1640 1500 1640 1520 {lab=N9}
N 1640 1520 2320 1520 {lab=N9}
...
N 3680 1500 3720 1500 {lab=#net1}
...
C {ipin.sym} -2400 1050 0 0 {name=p_P17 lab=P17}
C {ipin.sym} -2400 1350 0 0 {name=p_P19 lab=P19}
C {ipin.sym} -2400 -400 0 0 {name=p_P18 lab=P18}
C {opin.sym} 4800 -400 0 0 {name=p_S8 lab=S8}
C {iopin.sym} -2400 -600 0 0 {name=p_VDD lab=VDD}
C {iopin.sym} -2400 -700 0 0 {name=p_GND lab=GND}
C {lab_pin.sym} -1100 0 0 0 {name=l43 sig_type=std_logic lab=P13B}
C {lab_pin.sym} -1100 300 0 0 {name=l44 sig_type=std_logic lab=P14B}
C {lab_pin.sym} -1100 600 0 0 {name=l45 sig_type=std_logic lab=P15B}
C {lab_pin.sym} -1100 900 0 0 {name=l46 sig_type=std_logic lab=P16B}
C {opin.sym} 440 0 0 0 {name=p_S4 lab=S4}
C {lab_pin.sym} 100 300 0 0 {name=l47 sig_type=std_logic lab=N1}
C {lab_pin.sym} 100 600 0 0 {name=l48 sig_type=std_logic lab=N3}
C {lab_pin.sym} 100 900 0 0 {name=l49 sig_type=std_logic lab=N5}
C {lab_pin.sym} 100 1200 0 0 {name=l50 sig_type=std_logic lab=N8}
C {opin.sym} 1440 0 0 0 {name=p_S5 lab=S5}
C {lab_pin.sym} 1300 300 0 0 {name=l51 sig_type=std_logic lab=N2}
C {lab_pin.sym} 1300 600 0 0 {name=l52 sig_type=std_logic lab=N4}
C {lab_pin.sym} 1300 900 0 0 {name=l53 sig_type=std_logic lab=N6}
C {lab_pin.sym} 1300 1200 0 0 {name=l54 sig_type=std_logic lab=N7}
C {lab_pin.sym} 1300 1500 0 0 {name=l55 sig_type=std_logic lab=N9}
