...
N 280 80 320 80 {lab=P13}
N 280 120 320 120 {lab=P14}
N 480 100 520 100 {lab=S4_OUT}
N 400 40 400 60 {lab=Vdd}
N 400 140 400 160 {lab=GND}

# and_1A: P14, P15 -> net_1A
C {MG_and_gate.sym} 400 250 0 0 {name=U_AND3}
N 280 230 320 230 {lab=P14}
N 280 270 320 270 {lab=P15}
N 480 250 520 250 {lab=net_1A}
N 400 190 400 210 {lab=Vdd}
N 400 290 400 310 {lab=GND}

# and_1B: P15, P16 -> net_1B
C {MG_and_gate.sym} 400 400 0 0 {name=U_AND4}
N 280 380 320 380 {lab=P15}
N 280 420 320 420 {lab=P16}
N 480 400 520 400 {lab=net_1B}
N 400 340 400 360 {lab=Vdd}
N 400 440 400 460 {lab=GND}

# and_1C: P15_B, P14 -> net_1C
C {MG_and_gate.sym} 400 550 0 0 {name=U_AND9}
N 280 530 320 530 {lab=P15_B}
N 280 570 320 570 {lab=P14}
N 480 550 520 550 {lab=net_1C}
N 400 490 400 510 {lab=Vdd}
N 400 590 400 610 {lab=GND}

# and_Lbot: P13_B, P14_B -> net_Lbot
C {MG_and_gate.sym} 400 700 0 0 {name=U_AND13}
N 280 680 320 680 {lab=P13_B}
N 280 720 320 720 {lab=P14_B}
N 480 700 520 700 {lab=net_Lbot}
N 400 640 400 660 {lab=Vdd}
N 400 740 400 760 {lab=GND}

# and_S6_top: P13, P16 -> net_S6_top  (NEW - was missing from original file)
C {MG_and_gate.sym} 400 850 0 0 {name=U_AND16}
N 280 830 320 830 {lab=P13}
N 280 870 320 870 {lab=P16}
N 480 850 520 850 {lab=net_S6_top}
N 400 790 400 810 {lab=Vdd}
N 400 890 400 910 {lab=GND}
...
# --- OUTPUT PINS ---
# w1: P18 -> S8 (direct wire, no gate; opin stub is on the P18 net)
