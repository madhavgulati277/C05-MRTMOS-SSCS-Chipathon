...
"}
C {lab_pin.sym} -60 10 0 0 {name=p1 sig_type=std_logic lab=Vdd}
...
C {gnd.sym} 110 120 0 0 {name=l1 lab=0}
C {gnd.sym} -60 130 0 0 {name=l2 lab=0}
...
C {lab_pin.sym} 110 60 2 0 {name=p7 sig_type=std_logic lab=Vout}
C {vsource.sym} 130 -110 0 0 {name=V2 value="DC 0 AC 0.5" savecurrent=false}
C {lab_pin.sym} 30 -140 0 0 {name=p5 sig_type=std_logic lab=Vin+}
...
footprint=1206
device="ceramic capacitor"}
C {capa.sym} 320 -140 1 0 {name=C3
m=1
value=100m
footprint=1206
device="ceramic capacitor"}
