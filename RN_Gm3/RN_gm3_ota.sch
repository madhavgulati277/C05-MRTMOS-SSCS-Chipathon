...
N -420 -250 -420 -100 {lab=Vdd}
N -290 30 -190 30 {lab=#net3}
N -420 30 -420 40 {lab=#net3}
N -420 -20 -420 30 {lab=#net3}
N -510 10 -420 10 {lab=#net3}
N -420 30 -380 30 {lab=#net3}
...
C {symbols/ppolyf_u_3k.sym} -420 -50 0 0 {name=R1
W=2e-6
L=17.5e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -420 70 0 0 {name=R2
W=2e-6
L=7.5e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/cap_nmos_06v0.sym} -510 40 0 0 {name=C3
W=60e-6
L=10e-6
model=cap_nmos_06v0
spiceprefix=X
...
C {lab_pin.sym} -440 -50 0 0 {name=p2 sig_type=std_logic lab=GND}
C {lab_pin.sym} -440 70 0 0 {name=p3 sig_type=std_logic lab=GND}
C {lab_pin.sym} -510 70 0 0 {name=p4 sig_type=std_logic lab=GND}
C {lab_pin.sym} -420 100 0 0 {name=p7 sig_type=std_logic lab=GND}
