...
N -130 -260 -80 -260 {lab=#net2}
N -250 -200 -130 -200 {lab=#net3}
N -250 -290 -250 -260 {lab=Vdd}
N -250 -290 -80 -290 {lab=Vdd}
N -110 -230 -100 -230 {lab=GND}
...
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -30 -120 0 0 {name=R2
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
...
C {symbols/ppolyf_u_3k.sym} -130 -230 2 0 {name=R3
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -250 -230 0 0 {name=R4
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -70 -120 2 0 {name=R5
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -190 -120 0 0 {name=R6
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -230 -120 2 0 {name=R7
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -340 -120 0 0 {name=R8
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -380 -120 2 0 {name=R9
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
m=1}
C {symbols/ppolyf_u_3k.sym} -500 -120 0 0 {name=R10
W=2e-6
L=100e-6
model=ppolyf_u_3k
spiceprefix=X
