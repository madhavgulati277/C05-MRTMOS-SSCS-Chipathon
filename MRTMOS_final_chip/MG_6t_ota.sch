...
N 50 -10 50 40 {lab=#net2}
N 50 40 290 40 {lab=#net2}
N 290 -10 290 40 {lab=#net2}
N 170 100 240 100 {lab=GND}
N 170 190 240 190 {lab=GND}
N 170 40 170 70 {lab=#net2}
N 170 130 170 160 {lab=#net3}
N 170 220 170 270 {lab=GND}
N 170 -330 170 -250 {lab=Vdd}
N 130 -330 170 -330 {lab=Vdd}
N -50 100 130 100 {lab=#net4}
N -50 190 130 190 {lab=#net5}
N -120 -60 -120 20 {lab=Vdd}
N -120 80 -120 110 {lab=#net4}
N -120 100 -50 100 {lab=#net4}
N -120 170 -120 210 {lab=#net5}
N -120 190 -50 190 {lab=#net5}
N -120 270 -120 290 {lab=GND}
N -20 -160 60 -160 {lab=Vdd}
N 280 -160 360 -160 {lab=Vdd}
N 290 -90 440 -90 {lab=Vout}
N -300 100 -120 100 {lab=#net4}
N -300 190 -120 190 {lab=#net5}
N 170 -360 170 -330 {lab=Vdd}
N 170 -360 240 -360 {lab=Vdd}
N -120 -120 -0 -120 {lab=Vin+}
N -0 -120 -0 -40 {lab=Vin+}
N -0 -40 10 -40 {lab=Vin+}
N 360 -60 530 -60 {lab=Vin-}
N 360 -60 360 -40 {lab=Vin-}
...
C {ipin.sym} -120 -120 0 0 {name=p5 lab=Vin+
}
...
C {ipin.sym} 530 -60 0 1 {name=p6 lab=Vin-
}
...
C {symbols/cap_nmos_06v0.sym} -300 130 0 0 {name=C4
W=37e-6
L=37e-6
model=cap_nmos_06v0
spiceprefix=X
m=1}
C {symbols/cap_nmos_06v0.sym} -300 220 0 0 {name=C1
W=37e-6
L=37e-6
model=cap_nmos_06v0
spiceprefix=X
